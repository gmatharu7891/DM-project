...
#ifndef __ROBOTS_HH__
#define __ROBOTS_HH__
...
namespace My_Robot_Space {
    ...
    time_t move_a_robot(unsigned gridsize_NS, unsigned gridsize_EW,                        // careful: this is y,x not x,y as usual!
